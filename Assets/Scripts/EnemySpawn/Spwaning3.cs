...
public class Spwaning3 : MonoBehaviour
{
    ...
    IEnumerator waitSpawner()
    {
        ...
        while (!stop)
        {
            ...
            Vector3 spawnPosition = new Vector3(Random.Range(spawnValues.x - 3, spawnValues.x + 3), Random.Range(spawnValues.y + 12, spawnValues.y + 15), 0f);
